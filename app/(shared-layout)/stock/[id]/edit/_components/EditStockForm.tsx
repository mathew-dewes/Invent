...
import { SingleStockItem, Vendor } from "@/lib/types";
import { updateStock } from "@/lib/actions/stock";
import { toast } from "sonner";
import { useRouter } from "next/navigation";

export default function EditStockForm({vendors, values, stockId}:
    {vendors: Vendor[], values:SingleStockItem, stockId: string}
) {
    ...
    return (
        <Card className="w-full max-w-xl mx-auto mt-15">
            <CardHeader className="text-center">
                <CardTitle className="text-xl">Edit Stock</CardTitle>
